...
@media (max-width: 768px) {
    ...
    .hiw-step-body {
        ...
        width: 100%;
        max-width: 100%;
        padding-left: 55px; /* Indent to avoid ghost number */
        box-sizing: border-box;
    }
...
<!-- ================================================
     ...
     ================================================ -->
        ...
        <section class="box-by-industry{{ $isGiftBoxesPage ? ' gift-boxes-page' : '' }}" style="padding: {{ $isGiftBoxesPage ? '25px' : '25px' }} 5% 0;">
