...
Get A Call In A Min !</h5>
      ...
      <div class="modal-body">
        <form action="{{url('callback')}}" method="Post" id="call">
          ...
          <div class="g-recaptcha" id="recapchaheader2" required></div>
...
<?php $chk1++; if($chk1==1){?>
                                <ul class="nav navbar-nav uniq---ul">
                                    ...
                                    <li class="nav-item dropdown">
                                        <a class="nav-link dropdown-toggle" href="#">{{ $main_category->name }}</a>
                                        <?php $chk2=0;?>
        ...
        <?php $chk2++; if($chk2==1){ ?>
                ...
                <?php $chk3++; if($chk3==1){ ?>
                                                <ul class="dropdown-menu mega-dropdown-2">
                                                    <?php } ?>
                                                    <li class="mega-dropdown-items"><a class="dropdown-item" href="{{ url($products->url) }}">{{ $products->title }}</a></li>
                                                @endif
                @endforeach
                <?php if($chk3>0){ ?>
                                                </ul>
