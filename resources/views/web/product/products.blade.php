@include('web/header')
    ...
    <div id="content" class="site-content py-sm-5 py-4">
        ...
        <div class="container">
            <div class="row">
                <header class="col-12">
                    <h3 class="page-title"><span>{{ $category['0']->name }}</span></h3>
                </header>
            </div>
            <div class="row blog">
                                ...
                                <article  class=" post     ">
                                    <header class="entry-header">
                                        ...
                                        <div class="pb-post-meta">
                                            <div>
                                                <span class="newspaper-x-category"> <a href="{{ url($main->category_url)."/" }}">{{ $main->name }}</a></span><span class="pb-post-date">{{ $products->title }}</span>
                                            </div>
                                        </div>
                                    </header>
