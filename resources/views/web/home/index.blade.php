...
.quote-steps-col {
  width: 280px; background-color: var(--bg-darker);
  padding: 0;
  box-sizing: border-box;
  display: flex;
  align-items: stretch;
...
<section class="quote-section">
    <div class="quote-container">
        ...
        <div class="quote-form-col">
            ...
            <form class="instant-quote-form" id="homeQuoteForm" action="{{ url('submit-quote') }}" method="POST" enctype="multipart/form-data" spellcheck="false">
                @csrf
