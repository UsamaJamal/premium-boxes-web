    ...
    <section class="au-hero">
        <div class="au-container">
            ...
            <div class="au-card">
                ...
                <div class="au-avatar">
                    <img src="./d05f400a89e1f73c4f46d5c97263207f8af84580 (1).png" alt="Ahmed Khan">
                </div>

                <div class="au-info">
                    <h1 class="au-name">Ahmed Khan</h1>
                    <p class="au-role">Packaging Specialist &amp; Content Writer</p>
                    <p class="au-bio">
                        Specializing in custom rigid boxes, luxury packaging solutions, and packaging industry insights. Passionate about helping brands create memorable packaging experiences through innovative design and premium materials.
                    </p>
                    <a href="#" class="au-linkedin" aria-label="LinkedIn profile">
    ...
    <main class="au-posts">
        <div class="au-container">
            ...
            <div class="au-posts-grid">
                ...
                <article class="au-post-card">
                    <div class="au-post-thumb" style="background-image:url('./795621dde6787af154934c3b1e0ec13c3f0c7a6a (1).jpg')"></div>
                    <div class="au-post-body">
                        <div class="au-post-meta"><span class="au-post-author">Joe Danley</span><span class="au-post-date">Nov 15, 2026</span></div>
                        <h3 class="au-post-title">Sustainable Packaging Trends for 2026</h3>
                        <p class="au-post-desc">Explore how eco-friendly rigid boxes are transforming luxury packaging with sustainable materials and premium</p>
                    </div>
                </article>
                ...
                <article class="au-post-card">
                    ...
                    <div class="au-post-body">
                        <div class="au-post-meta"><span class="au-post-author">Joe Danley</span><span class="au-post-date">Nov 15, 2026</span></div>
                        <h3 class="au-post-title">Rigid Packaging Gluing: Adhesive Types &amp; Curing</h3>
                        <p class="au-post-desc">Explore how eco-friendly rigid boxes are transforming luxury packaging with sustainable materials and premium</p>
                    </div>
                </article>
