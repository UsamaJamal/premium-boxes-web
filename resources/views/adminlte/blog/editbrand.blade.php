        ...
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="card">
              ...
              <!-- form start -->
               <form id="basic-form" method="post" action="{{url('admin/update_brand'.'/'.$brand[0]->brand_id)}}" enctype="multipart/form-data"
>@csrf
            

             <input type="hidden" name="oldimage" value="{{$brand[0]->image}}">
    ...
    <div class="card-body">
                   ...
                   <div class="form-group row">
                    <label for="blogurl" class="col-sm-3 col-form-label">Brand URL</label>
                    <div class="col-sm-9">
                    <input id="blogurl" type="text" class="form-control"placeholder="Brand URL" name="brandurl" value="{{$brand[0]->url}}" >
                  </div>
                  </div>
    ...
    <div class="card-body">
               ...
               <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                    <input id="blogalttag" type="text" class="form-control" placeholder="Alttag" name="brandalttag"value="{{$brand[0]->alt_tag}}" >
                  </div>
                  </div>
                </div>
              </div>
