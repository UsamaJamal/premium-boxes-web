...
<input type="hidden" name="produ_id" value="{{$popular_product[0]->pop_product_id}}">
    ...
    <div class="card-body">
                <div class="form-group row">
                    <label class="col-sm-3 col-form-label">Popular Product</label>
                    <div class="col-sm-9">
                    <select id="related" name="pop_product[]" class="select2" multiple="" data-placeholder="Nothing Select" data-dropdown-css-class="" style="width: 100%;" data-select2-id="26" tabindex="-1" aria-hidden="true"> 
                    <?php $temp=json_decode($popular_product[0]->product_get); 
                    if(!empty($product)){ foreach ($product as $index){?>
