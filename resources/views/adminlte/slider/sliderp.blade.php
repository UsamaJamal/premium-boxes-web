  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Home Product Banner</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="{{ url('admin/dashboard') }}" style="color: #234376;">Home</a></li>
              <li class="breadcrumb-item active" style="color: #49d8f7;">Home Product Banner</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
          ...
          <div class="col-md-12">
            ...
            <div class="card">
              ...
              <div class="card-body">
               ...
               <form id="basic-form" method="post" action="{{url('admin/add_homepslider')}}"enctype="multipart/form-data"
>@csrf
                ...
                <div class="card" style="width: 66%; margin-left: 15px;">
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                    <input id="image" style="padding-bottom: 35px;" type="file" class="form-control" name="image4" required>
                  </div>
                  </div>
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                    <input id="homemtitle" type="text" class="form-control"placeholder="Alt Tag4" name="alttag4"  required>
                  </div>
                  </div>
                   ...
                   <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                    <input id="homemtitle" type="text" class="form-control"placeholder="Name4" name="name4"  required>
                  </div>
                  </div>
                   ...
                   <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                    <input id="homemtitle" type="text" class="form-control"placeholder="Link4" name="link4"  required>
                  </div>
                  </div>
                </div>
