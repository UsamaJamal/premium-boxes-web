        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Delivery Information Form</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
        ...
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
               <form method="post" action="{{url('admin/add_delivery_information')}}"enctype="multipart/form-data"
>@csrf
                <div class="card-body">
                	
                  <div class="form-group">
                    <label style="color: #5c89b5;">Meta Title</label>
                    <input type="text" class="form-control"placeholder="Meta Title" name="dpmtitle">
                  </div>

                  <div class="form-group">
                    <label style="color: #5c89b5;">Meta Tags</label>
                    <input type="text" class="form-control"placeholder="Meta Tags" name="dpmtags">
                  </div>

                  <div class="form-group">
                    <label style="color: #5c89b5;">Meta Description</label>
                    <input type="text" class="form-control"placeholder="Meta Description" name="dpmdescrioption">
                  </div>
